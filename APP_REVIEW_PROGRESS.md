...
- Commit a dependency lockfile (dependency, medium risk): package.json exists but no npm/pnpm/yarn lockfile was detected, which can make installs drift between local, CI, and deployment environments.
